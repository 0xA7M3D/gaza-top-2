...
function Login(){
    ...
    return(
        <div className="relative">
            ...
            <div className={`notefication2 border-b  absolute ${close? "-top-40":"-top-3"}  ${msg.error != null? "-top-3": "-top-30"} ${msg.error == false ? "border-green-400" :"border-red-300"} transition-all rounded-lg text-neutral-800 -translate-1/2 left-1/2 z-40 w-[450px] bg-gray-800 shadow-lg shadow-neutral-300/20`}>
            ...
            <div className="login gap-4 shadow-2xl flex flex-col items-center relative  p-5  py-9 bg-gray-800/80 text-black rounded-lg w-[450px] border-0 border-violet-400">
                ...
                <form onSubmit={send} method="post" className="contents">
                    <div className="inps flex flex-col py-4 w-full gap-4">
                        <div className="inp-1 flex relative items-center flex-row">
                            ...
                            <span className={`absolute -translate-1/2 ${faucus.facus1 ? "top-0 left-15 text-gray-700 text-sm":"top-1/2 left-15"} transition-all  text-gray-600 z-[1] `}> User @ </span>
                ...
                <Link to={'/sign/signup'}>
                    <p className="underline text-violet-400 tracking-[2px] text-sm"> Sign Up </p>
                </Link>
