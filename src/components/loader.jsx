...
function Loader() {
  ...
  return (
    !load ?
    <div className={`loader_cont ${load ? 'opacity-0 ': 'opacity-100'} transition-opacity duration-1000 z-[100] fixed -translate-1/2 top-1/2 flex-col gap-2 left-1/2 bg-white w-full h-full flex justify-center items-center`}>
      <div>
      ...
      <p className="font-sans text-blue-400 font-bold text-xl">صلي علي محمد</p>
    </div>
    :
    ''
