...
function Mood() {
    ...
    return (
        <div className="w-[46%] max-[640px]:w-[85%] max-[430px]:w-full ">
            <div className="settings flex-col  text-neutral-400 box border border-gray-800/75 overflow-hidden  font-medium   rounded-2xl shadow-lg shadow-gray-900/30 sec_prof flex items-center">
                ...
                <div className="input_check w-full select-none p-2">
                    <div className="setting-1 w-full">
                        ...
                        <div className="inputs_moods flex gap-3 justify-around flex-wrap py-3">

                            <label htmlFor="hh1" className="flex gap-2 items-center justify-center">
                                <p>Dark</p>
                                <div className="ff relative flex">
                                    <input className="inp1222 cursor-pointer appearance-none transition-all border border-purple-400 rounded-xl w-10 h-5 " type="checkbox" name="" id="hh1" />
