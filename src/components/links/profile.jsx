    ...
    return (
        <div className="w-[46%] max-[640px]:w-[85%]  max-[430px]:w-full flex flex-col gap-1">
            <div className="imges w-full relative ">
                ...
                <div className="img-profile w-24 h-24 rounded-full absolute -translate-1/2 top-full  left-1/4 border-2 border-[#09001a]">
            ...
            <div className="texts mt-11 p-2">
                ...
                <div className="desic w-full text-center text-black/20 text-sm pt-1">
            ...
            <div className="buttons flex gap-3 justify-between pt-2">
                <button className="edite p-1 py-1.5  w-1/2  text-center border border-purple-400/20 rounded-2xl text-purple-400 cursor-pointer text-sm hover:bg-purple-500/5 active:bg-purple-500 hover:text-[#efeff6] active:border-transparent active:text-[#efeff6] transition font-medium">Edite <i className="fa fa-pen"></i></button>
                <button className="story p-1 py-1.5  w-1/2  text-center border border-purple-400/20 rounded-2xl text-purple-400 cursor-pointer text-sm hover:bg-purple-500/5 active:bg-purple-500 hover:text-[#efeff6] active:border-transparent active:text-[#efeff6] transition font-medium">Add Story <i className="fa fa-plus"></i></button>
            </div>

            <hr className='w-full h-[1px] border-none my-2.5 mt-4 bg-linear-to-l from-neutral-100/0 via-neutral-400 rounded-full to-neutral-100/0'/>
                    ...
                    <div className="post-1  bg-black/20 overflow-hidden rounded-2xl shadow-lg shadow-gray-800/30 w-full">
                        ...
                        <div className="reacts">
                            <div className="btns flex justify-between flex-row-reverse">
                                <button className='w-full text-center p-2 hover:bg-black/30 active:bg-black/30 transition text-purple-400 cursor-pointer '><i className="fa fa-hand-peace"></i></button>
                                <button className='w-full text-center text-gray-400 p-2 hover:bg-black/30 active:bg-black/30 transition  cursor-pointer'><i className="fal fa-share"></i></button>
                                <button className='w-full text-center text-gray-400 p-2 hover:bg-black/30 active:bg-black/30 transition  cursor-pointer'><i className="fal fa-comment"></i></button>
                            </div>
                        </div>
                    </div>
